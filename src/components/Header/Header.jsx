...
const Header = () => {
  ...
  return (
    <header className="bg-[#00395D] h-[90px] w-full mx-auto shadow-md flex justify-between items-center px-4 flex-row ">
      <div className="flex-wrap-reverse logo">
        <img
          src={logo}
          alt="Logo"
          className="h-[39px] w-[253px] p-[10px] gap-[10px] top-[26px]"
        />
      </div>
      ...
      <div>
        ...
        <div className="flex bg-[#5C8CAA] items-center border-2 border-[#5C8CAA] rounded-[12px] p-2 space-x-2 space-x-reverse flex-row">
          <img
            src={userProfile}
            alt="userProfile"
        ...
        <div className="aicons p-[10px] flex flex-row">
